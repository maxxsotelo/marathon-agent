...
plan = {
    "meta": {
        ...
        "wrist_note":  "Right wrist injury ongoing. Avoid push movements (bench, push-ups, dips). Pull movements cleared.",
    ...
    "days": {
        ...
        "2026-06-30": {
            "label":   "Tuesday | Quality Session + Home Upper Body",
            "session": "Home — Upper Body (Pull/Core only) + 8-10 km Quality Run (Outside)",
            "detail":  "Home Workout (AM): Pull and core movements only (e.g., towel rows, backpack rows, supermans, hollow body holds). No push-ups/planks due to wrist. Run (PM): 8-10 km total, including a 4 km tempo block. Let HR rise into Z3/Z4 during the quality portion.",
            "run_km":  9,
            "gym":     False,
            "plyo":    False,
        },
        "2026-07-01": {
            "label":   "Wednesday | Legs + Core (Wrist-Safe)",
            "session": "Gym — Legs + Core",
            "detail":  "Base leg day (Leg press, stability ball hamstring curls, core circuit). No plyometrics.",
            "run_km":  0,
            "gym":     True,
            "plyo":    False,
        },
        "2026-07-02": {
            "label":   "Thursday | Zone 2 Aerobic",
            "session": "8–10 km Zone 2 Aerobic (Outside)",
            "detail":  "Steady Zone 2 (162-174 bpm). Strict HR cap. Focus on cadence ~175spm.",
            "run_km":  9,
            "gym":     False,
            "plyo":    False,
        },
        "2026-07-03": {
            ...
            "session": "Complete Rest or Z1 Bike",
            "detail":  "Pre-weekend recovery. Let the legs rest entirely.",
            "run_km":  0,
            "gym":     False,
            "plyo":    False,
        },
