...
print(f"Creating and scheduling scaled 6.0km Road Tempo workout for {today_str}...")
...
# 1. Warm-up: 1.0 km (1000m) in Zone 1 (130-161 bpm)
step1 = ExecutableStep(
    ...
    description="1.0km Easy Road Warm-up in Zone 1 (< 161 bpm)"
)

# 2. Road Tempo Block: 4.0 km (4000m) in Zone 3 (175-181 bpm)
step2 = ExecutableStep(
    ...
    description="4.0km Road Tempo @ Marathon Pace in Zone 3 (175-181 bpm)"
)

# 3. Cool-down: 1.0 km (1000m) in Zone 1 (130-161 bpm)
step3 = ExecutableStep(
    ...
    targetValueOne=float(HR_ZONES[1]["low"]),
    targetValueTwo=float(HR_ZONES[1]["high"]),
    description="1.0km Cool-down flush in Zone 1"
)

workout_name = "Road Tempo – 4km MP (6.0km Total)"
workout = RunningWorkout(
    workoutName=workout_name,
    description="1.0km Warmup in Zone 1 (<161 bpm) + 4.0km Road Tempo in Zone 3 (175-181 bpm) + 1.0km Cooldown in Zone 1",
